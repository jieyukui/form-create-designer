<template>
    <div id="app">
        ...
        <fc-designer ref="designer" :config="config" :handle="handle" :locale="locale" :code-editor-config="codeEditorConfig">
            <template #handle>
                <div class="handle">
                    <el-dropdown>
        ...
        return {
            ...
            codeEditorConfig: {
              ...
              customObjects: {
                tableTool: {
                  age: 234,
                  getAssignTableData: (queryID, query, pageSize) => [{ queryID, name: '数据源编号' }, { query, name: '传递数据源的参数数据' }, { pageSize, name: '返回数据条数' }],
                }
              },
              // 自定义函数签名
              customSignatures: {
